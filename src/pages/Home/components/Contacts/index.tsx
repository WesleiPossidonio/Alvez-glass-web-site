...
export const Contacts = () => {
  ...
  return (
    <section
      className="w-full h-auto min-h-[40rem] flex flex-col items-center justify-content-center gap-5 bg-white relative px-6 md:px-16"
      id="contacts"
    >
      <div
        className="w-full container xl:max-w-[80%] h-auto min-h-[35rem] py-14 md:px-8 flex flex-col gap-16"
        data-aos="zoom-in"
      ...
      >
        <div className="flex flex-col items-center justify-center gap-1">
          ...
          <div className="flex flex-col items-center justify-center gap-1">
            <h1 className="md:text-5xl text-black text-2xl font-bold text-center">
              Vamos Conversar!{" "}
            </h1>
            <h2 className="text-sm md:text-md lg:text-lg text-black text-center">
              Entre em Contato e Dê o Próximo Passo para Impulsionar Seu
              Projeto.
            </h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-16">
          <div className="col-span-2 lg:col-span-1 flex flex-col items-start justify-start gap-2">
            ...
            <p className="text-sm md:text-md lg:text-lg">
              Entre em contato com nossa equipe e tire suas dúvidas, faça um
              orçamento ou agende um atendimento personalizado.
            </p>
            ...
            <div className="flex flex-col items-start justify-center gap-3 mt-5">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="">
                  ...
                  <a href="#" className="text-sm md:text-md font-semibold">
                    R. Otávio Laurindo <br className="md:hidden" /> de Azevedo,
                    N° 1040, <br /> Praia Campista, Macaé - RJ
                  </a>
                </div>
              </div>
            </div>
          ...
          <form
            ...
            className="w-full grid grid-cols-2 gap-6 col-span-2 lg:col-span-1"
            action=""
          >
            <Input
              className="col-span-2 md:col-span-1 py-3.5 md:py-6 
            ...
            />
            <Input
              className="py-3.5 md:py-6 text-sm md:text-md col-span-2
          text-black placeholder:text-black bg-white"
            ...
            />
            <Textarea
              className=" h-25 md:h-48 md:py-6 text-sm md:text-md col-span-2 
          text-black placeholder:text-black bg-white"
              placeholder="Digite sua Mensagem"
              {...register("subject_text")}
            />
            <Button
              className="md:w-1/2 px-4 py-5 md:py-7 text-lg md:text-xl bg-base-blue
            hover:bg-base-blue-hover mt-2"
            >
              Enviar
            </Button>
          </form>
      ...
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3688.877171742176!2d-41.79094592377121!3d-22.395987419817306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x96308a263ac2dd%3A0xee6992d202a10b1d!2sAlves%20Glass%20Servi%C3%A7os!5e0!3m2!1spt-BR!2sbr!4v1754438286292!5m2!1spt-BR!2sbr"
        loading="lazy"
        className="w-full h-92 rounded-2xl"
      ></iframe>
    </section>
  );
};
