      ...
      <div className="container mx-auto py-10 px-8 space-y-5 flex flex-col items-start justify-center gap-7 relative z-5">
        ...
        >
          <div className="self-center text-center">
            <h1 className="text-white text-3xl md:text-5xl font-semibold drop-shadow-md">
            ...
            <p className="text-white text-md md:text-lg m-0 self-start drop-shadow-md mt-5">
              Soluções sob medida que unem estética refinada e performance. Um
              novo padrão de acabamento para quem exige o melhor.
            </p>

            <Button
              className="w-max py-7 mt-4 text-lg bg-base-blue border
